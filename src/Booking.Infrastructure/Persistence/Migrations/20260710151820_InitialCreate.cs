        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Doctors_YearsOfExperience", "\"YearsOfExperience\" >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClinicAdministrators", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClinicAdministrators_Clinics_ClinicId",
                        column: x => x.ClinicId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dependents_PatientProfiles_PatientProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_MedicalServices_Duration", "\"DurationMinutes\" > 0");
                    table.CheckConstraint("CK_MedicalServices_Price", "\"Price\" >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorClinicBranches", x => new { x.DoctorId, x.ClinicBranchId });
                    table.ForeignKey(
                        name: "FK_DoctorClinicBranches_ClinicBranches_ClinicBranchId",
                        column: x => x.ClinicBranchId,
                        principalTable: "ClinicBranches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorClinicBranches_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_DoctorUnavailabilities_Times", "\"EndDateTime\" > \"StartDateTime\"");
                    table.ForeignKey(
                        name: "FK_DoctorUnavailabilities_ClinicBranches_ClinicBranchId",
                        column: x => x.ClinicBranchId,
                        principalTable: "ClinicBranches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_DoctorWorkingSchedules_SlotDuration", "\"SlotDurationMinutes\" > 0");
                    table.CheckConstraint("CK_DoctorWorkingSchedules_Times", "\"EndTime\" > \"StartTime\"");
                    table.ForeignKey(
                        name: "FK_DoctorWorkingSchedules_ClinicBranches_ClinicBranchId",
                        column: x => x.ClinicBranchId,
                        principalTable: "ClinicBranches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Appointments_Times", "\"EndDateTime\" > \"StartDateTime\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorServices", x => new { x.DoctorId, x.MedicalServiceId });
                    table.CheckConstraint("CK_DoctorServices_CustomDuration", "\"CustomDurationMinutes\" IS NULL OR \"CustomDurationMinutes\" > 0");
                    table.CheckConstraint("CK_DoctorServices_CustomPrice", "\"CustomPrice\" IS NULL OR \"CustomPrice\" >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_ClinicBranchId_StartDateTime",
                table: "Appointments",
                columns: new[] { "ClinicBranchId", "StartDateTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_DoctorId_StartDateTime_EndDateTime",
                table: "Appointments",
                columns: new[] { "DoctorId", "StartDateTime", "EndDateTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicAdministrators_ClinicId",
                table: "ClinicAdministrators",
                column: "ClinicId");

            migrationBuilder.CreateIndex(
                name: "IX_ClinicAdministrators_UserId",
                table: "ClinicAdministrators",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ClinicAdministrators_UserId_ClinicId",
                table: "ClinicAdministrators",
                columns: new[] { "UserId", "ClinicId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClinicBranches_City",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dependents_PatientProfileId",
                table: "Dependents",
                column: "PatientProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorClinicBranches_ClinicBranchId",
                table: "DoctorClinicBranches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorUnavailabilities_ClinicBranchId",
                table: "DoctorUnavailabilities",
                column: "ClinicBranchId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorUnavailabilities_DoctorId_StartDateTime_EndDateTime",
                table: "DoctorUnavailabilities",
                columns: new[] { "DoctorId", "StartDateTime", "EndDateTime" });

            migrationBuilder.CreateIndex(
                name: "IX_DoctorWorkingSchedules_ClinicBranchId",
                table: "DoctorWorkingSchedules",
                column: "ClinicBranchId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorWorkingSchedules_DoctorId_ClinicBranchId_DayOfWeek",
                table: "DoctorWorkingSchedules",
                columns: new[] { "DoctorId", "ClinicBranchId", "DayOfWeek" });
